...
class WinView(
    ...
    init {
        ...
        val header = Components.textBox(GameConfig.WINDOW_WIDTH / 2)
                .addHeader(msg)
                .addNewLine()
                .addParagraph("Congratulations! You have escaped from Alterna!", withNewLine = false)
                .addParagraph("You've managed to find $sardiniums Sardinium.")       // 1
